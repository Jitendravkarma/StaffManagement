            ...
            <div className="row">
                <div className="col-lg-6 col-sm-6 mt-3 mb-3 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="service-item text-center pt-3">
                        <div className="p-4">
                            <img src="assets/img/study.jpg" style={{"width":"100%","height":"250px"}}/>
                ...
                <div className="col-lg-6 col-sm-6 mt-3 mb-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div className="service-item text-center pt-3">
                        <div className="p-4">
                            <img src="assets/img/game.jpg" style={{"width":"100%","height":"250px"}}/>
                ...
                <div className="col-lg-6 col-sm-6 mt-3 mb-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div className="service-item text-center pt-3">
                        <div className="p-4">
                            <img src="assets/img/play.jpg" style={{"width":"100%","height":"250px"}}/>
                ...
                <div className="col-lg-6 col-sm-6 mt-3 mb-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div className="service-item text-center pt-3">
                        <div className="p-4">
                            <img src="assets/img/creative.jpg" style={{"width":"100%","height":"250px"}}/>
